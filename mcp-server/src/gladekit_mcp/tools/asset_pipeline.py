...
CATEGORY = {
    ...
    "keywords": [
        "asset", "assets", "sprite", "sprites", "tileset", "tilemap", "tiles",
        "model", "3d model", "fbx", "voxel", "low-poly",
        "sound", "sfx", "audio", "wav", "ogg",
        "ui", "icon", "icons", "button", "menu", "hud",
        "free", "kenney", "cc0", "creative commons",
        "find an asset", "import asset", "asset pack", "art pack",
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "asset_type": {
                        "type": "string",
                        "enum": [
                            "sprite_2d", "model_3d", "audio_sfx",
                            "audio_music", "animation", "ui_sprite",
                        ],
